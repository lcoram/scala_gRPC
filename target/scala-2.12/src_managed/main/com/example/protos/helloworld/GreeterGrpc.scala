package com.example.protos.helloworld

object GreeterGrpc {
  val METHOD_SAY_HELLO: _root_.io.grpc.MethodDescriptor[com.example.protos.helloworld.HelloRequest, com.example.protos.helloworld.HelloReply] =
    _root_.io.grpc.MethodDescriptor.newBuilder()
      ...
      .setRequestMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[com.example.protos.helloworld.HelloRequest])
      .setResponseMarshaller(_root_.scalapb.grpc.Marshaller.forMessage[com.example.protos.helloworld.HelloReply])
      .build()
  
  val SERVICE: _root_.io.grpc.ServiceDescriptor =
    _root_.io.grpc.ServiceDescriptor.newBuilder("com.example.protos.Greeter")
      .setSchemaDescriptor(new _root_.scalapb.grpc.ConcreteProtoFileDescriptorSupplier(com.example.protos.helloworld.HelloworldProto.javaDescriptor))
      .addMethod(METHOD_SAY_HELLO)
      .build()
  
  trait Greeter extends _root_.scalapb.grpc.AbstractService {
    override def serviceCompanion = Greeter
    def sayHello(request: com.example.protos.helloworld.HelloRequest): scala.concurrent.Future[com.example.protos.helloworld.HelloReply]
  }
  ...
  object Greeter extends _root_.scalapb.grpc.ServiceCompanion[Greeter] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.ServiceDescriptor = com.example.protos.helloworld.HelloworldProto.javaDescriptor.getServices().get(0)
  }
  
  trait GreeterBlockingClient {
    def serviceCompanion = Greeter
    def sayHello(request: com.example.protos.helloworld.HelloRequest): com.example.protos.helloworld.HelloReply
  }
  ...
  class GreeterBlockingStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterBlockingStub](channel, options) with GreeterBlockingClient {
    override def sayHello(request: com.example.protos.helloworld.HelloRequest): com.example.protos.helloworld.HelloReply = {
  ...
  class GreeterStub(channel: _root_.io.grpc.Channel, options: _root_.io.grpc.CallOptions = _root_.io.grpc.CallOptions.DEFAULT) extends _root_.io.grpc.stub.AbstractStub[GreeterStub](channel, options) with Greeter {
    override def sayHello(request: com.example.protos.helloworld.HelloRequest): scala.concurrent.Future[com.example.protos.helloworld.HelloReply] = {
  ...
  def bindService(serviceImpl: Greeter, executionContext: scala.concurrent.ExecutionContext): _root_.io.grpc.ServerServiceDefinition =
    ...
    .addMethod(
      METHOD_SAY_HELLO,
      _root_.io.grpc.stub.ServerCalls.asyncUnaryCall(new _root_.io.grpc.stub.ServerCalls.UnaryMethod[com.example.protos.helloworld.HelloRequest, com.example.protos.helloworld.HelloReply] {
        override def invoke(request: com.example.protos.helloworld.HelloRequest, observer: _root_.io.grpc.stub.StreamObserver[com.example.protos.helloworld.HelloReply]): Unit =
